...
##################### PREGUNTAS DE CUARTO NIVEL #####################

renglones = Preguntas.BancoPreguntas.cuartoNivel()
n_pregunta = 0
base_de_preguntas = []
...
def jugar():
    ...
    while True:
        ...
        if(n_pregunta==cantidadDePreguntas):            
            borrarConsola()
            print("Cuarto nivel superado, uno mas!")
            valorPremio = 4000000
            ...
            if (confirmacion==1):
                ...
                input("ENTER PARA CONTINUAR")
                borrarConsola()
                import Niveles.QuintoNivel
                Niveles.QuintoNivel.jugar()
            elif (confirmacion==2):
